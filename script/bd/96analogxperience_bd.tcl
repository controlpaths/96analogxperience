...
################################################################
# This is a generated script based on design: ax96_bd
#
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\
user.org:user:cp_96AnalogXperience:1.0\
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__ACT_DDR_FREQ_MHZ {528.000000} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins cp_96AnalogXperience_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net cp_96AnalogXperience_0_o_cs [get_bd_ports dac_cs] [get_bd_pins cp_96AnalogXperience_0/o_cs]
  connect_bd_net -net cp_96AnalogXperience_0_o_sck [get_bd_ports dac_sck] [get_bd_pins cp_96AnalogXperience_0/o_sck]
  connect_bd_net -net cp_96AnalogXperience_0_o_sdo [get_bd_ports dac_sdo] [get_bd_pins cp_96AnalogXperience_0/o_sdo]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins cp_96AnalogXperience_0/s00_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins cp_96AnalogXperience_0/s00_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs cp_96AnalogXperience_0/S00_AXI/S00_AXI_reg] SEG_cp_96AnalogXperience_0_S00_AXI_reg
