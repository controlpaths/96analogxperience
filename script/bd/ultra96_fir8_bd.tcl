...
################################################################
# This is a generated script based on design: ultra96_bd
#
...
# source ultra96_bd_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# cen_generator_v1_0, dacx0004_driver_v2_0, signal_generator_v1_0
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
controlpaths:signal:axi_fir8:1.0\
...
proc create_root_design { parentCell } {
  ...
  set dac_sdo [ create_bd_port -dir O dac_sdo ]

  # Create instance: axi_fir8_0, and set properties
  set axi_fir8_0 [ create_bd_cell -type ip -vlnv controlpaths:signal:axi_fir8:1.0 axi_fir8_0 ]
  set_property -dict [ list \
   CONFIG.param_coeff_decimal {31} \
   CONFIG.param_io_decimal {15} \
   CONFIG.param_io_width {16} \
 ] $axi_fir8_0
  ...
  # Create instance: dacx0004_driver_v2_0_0, and set properties
  set block_name dacx0004_driver_v2_0
  set block_cell_name dacx0004_driver_v2_0_0
  if { [catch {set dacx0004_driver_v2_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dacx0004_driver_v2_0_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: signal_generator_v1_0_0, and set properties
  set block_name signal_generator_v1_0
  set block_cell_name signal_generator_v1_0_0
  if { [catch {set signal_generator_v1_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $signal_generator_v1_0_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins axi_fir8_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axi_fir8_0_out_data [get_bd_pins axi_fir8_0/out_data] [get_bd_pins dacx0004_driver_v2_0_0/is16_data_ch0] [get_bd_pins dacx0004_driver_v2_0_0/is16_data_ch2]
  connect_bd_net -net cen_generator_v1_0_0_or_cen [get_bd_pins axi_fir8_0/cen] [get_bd_pins cen_generator_v1_0_0/or_cen] [get_bd_pins dacx0004_driver_v2_0_0/ce] [get_bd_pins signal_generator_v1_0_0/cen]
  connect_bd_net -net dacx0004_driver_v2_0_0_o_sdo [get_bd_ports dac_sdo] [get_bd_pins dacx0004_driver_v2_0_0/o_sdo]
  connect_bd_net -net dacx0004_driver_v2_0_0_or_cs [get_bd_ports dac_cs] [get_bd_pins dacx0004_driver_v2_0_0/or_cs]
  connect_bd_net -net dacx0004_driver_v2_0_0_or_sck [get_bd_ports dac_sck] [get_bd_pins dacx0004_driver_v2_0_0/or_sck]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_fir8_0/s00_axi_aresetn] [get_bd_pins cen_generator_v1_0_0/rstn] [get_bd_pins dacx0004_driver_v2_0_0/rstn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins signal_generator_v1_0_0/rstn]
  connect_bd_net -net signal_generator_v1_0_0_o16_signal [get_bd_pins axi_fir8_0/in_data] [get_bd_pins dacx0004_driver_v2_0_0/is16_data_ch1] [get_bd_pins signal_generator_v1_0_0/ors16_signal]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins cen_generator_v1_0_0/i32_prescaler] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins dacx0004_driver_v2_0_0/is16_data_ch3] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_fir8_0/s00_axi_aclk] [get_bd_pins cen_generator_v1_0_0/clk] [get_bd_pins dacx0004_driver_v2_0_0/clk100mhz] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins signal_generator_v1_0_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fir8_0/S00_AXI/S00_AXI_reg] SEG_axi_fir8_0_S00_AXI_reg
